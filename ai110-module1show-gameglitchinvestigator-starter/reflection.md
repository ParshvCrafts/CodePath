...
I used Claude (via Claude Code / Agent mode) as my main AI tool for this project. I described the bugs I was seeing while playing the game, and it read through the code with me to find what was actually causing them.
